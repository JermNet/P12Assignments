...
public class GraphicalShapeV2 {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    GraphicalShapeV2 window = new GraphicalShapeV2();
                ...
                if (radioSphere.isSelected()) {
                    if (area.isSelected() && volume.isSelected()) {
                        output.setText(
                                "The radius you chose was " + radiusField.getText() + ". So your surface area is "
                                        + Shapes.sphereArea(Double.parseDouble(radiusField.getText())) + "."
                                        + " And your volume is "
                                        + Shapes.sphereVolume(Double.parseDouble(radiusField.getText())));
                    } else if (area.isSelected()) {
                        output.setText("The radius you chose was " + radiusField.getText() + ". So your"
                                + " surface area is " + Shapes.sphereArea(Double.parseDouble(radiusField.getText())));
                    ...
                    if (area.isSelected() && volume.isSelected()) {
                        output.setText("Your length, width and height are " + lengthField.getText() + ", "
                                ...
                                + Shapes.pyramidArea(Double.parseDouble(lengthField.getText()),
                                Double.parseDouble(widthField.getText()),
                                Double.parseDouble(heightField.getText()))
                                + "."
                                + " And your volume is "
                                + Shapes.pyramidVolume(Double.parseDouble(lengthField.getText()),
                                Double.parseDouble(widthField.getText()),
                                Double.parseDouble(heightField.getText())));
                    } else if (area.isSelected()) {
                        output.setText("Your length, width and height are " + lengthField.getText() + ", "
                    ...
                    if (area.isSelected() && volume.isSelected()) {
                        output.setText("Your radius and height are " + radiusField2.getText() + " and "
                                ...
                                + Shapes.cylinderArea(Double.parseDouble(radiusField2.getText()),
                                Double.parseDouble(heightField2.getText()))
                                + "."
                                + " And your volume is "
                                + Shapes.cylinderVolume(Double.parseDouble(radiusField2.getText()),
                                Double.parseDouble(heightField2.getText())));
                    } else if (area.isSelected()) {
                        output.setText("Your radius and height are " + radiusField2.getText() + " and "
                                + heightField2.getText() + ". "
